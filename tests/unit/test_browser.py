...
class TestCreateLLM:
    ...
    def test_create_llm_anthropic(self):
        ...
        with patch.dict(os.environ, {
            ...
            with patch("browser_use.ChatAnthropic") as mock_chat:
    ...
    def test_create_llm_google(self):
        ...
        with patch.dict(os.environ, {
            ...
            with patch("browser_use.ChatGoogle") as mock_chat:
                llm = create_llm(temperature=0.5)
                mock_chat.assert_called_once_with(
    ...
    def test_create_llm_browser_use(self):
        ...
        with patch.dict(os.environ, {
            ...
            with patch("browser_use.ChatBrowserUse") as mock_chat:
                llm = create_llm(temperature=0.5)
                mock_chat.assert_called_once_with(
                    temperature=0.5,
                )
    ...
    def test_create_llm_groq(self):
        ...
        with patch.dict(os.environ, {
            ...
            with patch("browser_use.ChatGroq") as mock_chat:
                llm = create_llm(temperature=0.5)
                mock_chat.assert_called_once_with(
    ...
    def test_create_llm_azure(self):
        ...
        with patch.dict(os.environ, {
            ...
            with patch("browser_use.ChatAzureOpenAI") as mock_chat:
                llm = create_llm(temperature=0.5)
                mock_chat.assert_called_once_with(
                    model="gpt-4o",
                    temperature=0.5,
